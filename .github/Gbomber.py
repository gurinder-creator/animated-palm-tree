...
# This is copy of the tool (inspired from speedX)
country_codes = {
    '93': 'AF',
    '355': 'AL',
    '213': 'DZ',
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        try:
            ...
            if cc == "91":
                ...
                if success > 0:
                    ...
                    print(
                        '\t\tPlease Send A Mail To guri6656656@gmail.com To Let Us Know...')
                    input('Press Enter To Exit...')
                    exit()
        ...
        print("              This Bomber Was Created By itsgurinderjit !!     ")           
        print("==================================================================")
        try:
